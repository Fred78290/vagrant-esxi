...
require "vagrant-esxi/version"

Gem::Specification.new do |spec|
  spec.name          = "vagrant-esxi"
  spec.version       = VagrantPlugins::ESXi::VERSION
  spec.authors       = ["Frédéric BOLTZ"]
  spec.email         = ["frederic.boltz@gmail.com"]

  spec.summary       = "VMWare ESXi provider"
  spec.description   = "Enables Vagrant to manage machines with VMWare ESXi."
  spec.homepage      = "https://github.com/Fred78290/vagrant-esxi"
  spec.license       = "MIT"
